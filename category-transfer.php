<?php get_header(); ?>
    ...
    <section class="b-pageHeader">
        <div class="row">
            <h1 class="wow zoomInLeft" data-wow-delay="0.7s"><?php echo get_cat_name(6);?></h1>
        </div>
                            ...
                            <div class="b-items__cell wow zoomInUp" data-wow-delay="0.5s">
                                ...
                                <div class="b-items__cell-info">
                                    ...
                                    <div class="row m-smallPadding">
                                        <?php if(has_tag()){the_tags('<div class="col-xs-12 text-dop"><div class="meta-tags">','','</div></div>');}?>
                                        <div class="col-xs-6">
                                            <h5 class="b-items__cell-info-price"><?php the_field('cost'); ?> руб.</h5>
                                        </div>
                                        <div class="col-xs-6">
