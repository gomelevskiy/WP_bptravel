            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-xs-12">
                    <div class="b-detail__head-price">
                        <div class="b-detail__head-price-num"><?php the_field('hotel-cost'); ?> руб.</div>
                            ...
                            <div class="row m-smallPadding">
                                <div class="col-xs-10">
                                    <ul class="b-detail__main-info-images-big bxslider enable-bx-slider" data-pager-custom="#bx-pager" data-mode="horizontal" data-pager-slide="true" data-mode-pager="vertical" data-pager-qty="5">
                                        <li class="s-relative">
                                            <img class="img-responsive center-block" src="<?php the_field('hotel-img'); ?>" />
                                        </li>
                                        <?php if( get_field('hotel-slide1') ): ?>
                                            <li class="s-relative">
                                                <img class="img-responsive center-block" src="<?php the_field('hotel-slide1'); ?>" />
                                            </li>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide2') ): ?>
                                            <li class="s-relative">
                                                <img class="img-responsive center-block" src="<?php the_field('hotel-slide2'); ?>" />
                                            </li>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide3') ): ?>
                                            <li class="s-relative">
                                                <img class="img-responsive center-block" src="<?php the_field('hotel-slide3'); ?>" />
                                            </li>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide4') ): ?>
                                            <li class="s-relative">
                                                <img class="img-responsive center-block" src="<?php the_field('hotel-slide4'); ?>" />
                                            </li>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide5') ): ?>
                                            <li class="s-relative">
                                                <img class="img-responsive center-block" src="<?php the_field('hotel-slide5'); ?>" />
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                    ...
                                    <div class="b-detail__main-info-images-small" id="bx-pager">
                                        ...
                                        <?php if( get_field('hotel-slide1') ): ?>
                                            <a href="#" data-slide-index="1" class="b-detail__main-info-images-small-one">
                                                <img class="img-responsive" src="<?php the_field('hotel-slide1'); ?>" />
                                            </a>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide2') ): ?>
                                            <a href="#" data-slide-index="2" class="b-detail__main-info-images-small-one">
                                                <img class="img-responsive" src="<?php the_field('hotel-slide2'); ?>" />
                                            </a>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide3') ): ?>
                                            <a href="#" data-slide-index="3" class="b-detail__main-info-images-small-one">
                                                <img class="img-responsive" src="<?php the_field('hotel-slide3'); ?>" />
                                            </a>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide4') ): ?>
                                            <a href="#" data-slide-index="4" class="b-detail__main-info-images-small-one">
                                                <img class="img-responsive" src="<?php the_field('hotel-slide4'); ?>" />
                                            </a>
                                        <?php endif; ?>
                                        <?php if( get_field('hotel-slide5') ): ?>
                                            <a href="#" data-slide-index="5" class="b-detail__main-info-images-small-one">
                                                <img class="img-responsive" src="<?php the_field('hotel-slide5'); ?>" />
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                </div>
